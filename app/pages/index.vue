  ...
  <PageWrapper :loading="loading" loading-message="Chargement des personnages..." :custom-background="true">
    ...
    <div v-if="!personnageActif">
        ...
        <div class="absolute top-4 right-4 z-20">
          <button
            @click="handleLogout"
            class="px-4 py-2 bg-white/80 hover:bg-white text-stone-600 hover:text-red-800 rounded-lg transition-colors font-montserrat flex items-center gap-2 shadow-md"
          >
